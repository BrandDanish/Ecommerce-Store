...
const Footer = () => {
    return (
        <div className="w-full bg-black text-white flex justify-center items-center py-12">
            <div className="w-full max-w-[1170px] flex flex-row justify-between items-start gap-12">
                {/* Exclusive */}
                <div className="flex flex-col items-start gap-4 flex-1 min-w-[180px]">
                    <span className="font-bold text-2xl mb-2">Exclusive</span>
                    <span>Subscribe</span>
                    <span>Get 10% off your first order</span>
<div className="flex items-center gap-2 border border-[#FAFAFA] rounded mt-2 px-[10px] py-2 w-[240px] h-[48px]">
  <input
    type="email"
  ...
  />
                ...
                {/* Support */}
                <div className="flex flex-col items-start gap-2 flex-1 min-w-[180px]">
                ...
                {/* Download App */}
                <div className="flex flex-col items-start gap-4 flex-1 min-w-[220px]">
                    <span className="font-bold text-2xl mb-2">Download App</span>
                    <p className="text-[#908e8e] font-bold whitespace-nowrap">Save $3 With App New User Only</p>
